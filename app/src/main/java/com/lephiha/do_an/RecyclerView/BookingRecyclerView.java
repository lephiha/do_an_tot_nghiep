...
public class BookingRecyclerView extends RecyclerView.Adapter<BookingRecyclerView.ViewHolder> {
    ...
    @NonNull
    @Override
    public BookingRecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recycler_view_booking, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (element.getService().getImage().length() > 0) {
            String serviceImage = Constant.UPLOAD_URI() + element.getService().getName();
