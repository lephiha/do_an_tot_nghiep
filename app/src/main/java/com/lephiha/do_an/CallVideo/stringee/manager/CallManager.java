...
public class CallManager {
    ...
    public CallManager(Context context) {
        ...
        this.audioManagerUtils.setAudioEvents(selectedAudioDevice -> Utils.runOnUiThread(() -> Log.d(Constant2.TAG, "onAudioEvents: selectedAudioDevice - " + selectedAudioDevice.name())));
        ...
        if (isStringeeCall) {
            stringeeCall.setCallListener(new StringeeCall.StringeeCallListener() {
                ...
                public void onSignalingStateChange(StringeeCall stringeeCall, StringeeCall.SignalingState signalingState, String reason, int sipCode, String sipReason) {
                    Utils.runOnUiThread(() -> {
                        Log.d(Constant2.TAG, "onSignalingStateChange: " + signalingState);
                ...
                public void onError(StringeeCall stringeeCall, int code, String desc) {
                    Utils.runOnUiThread(() -> {
                        Log.d(Constant2.TAG, "onError: " + desc);
                        callStatus = CallStatus.ENDED;
                        if (listener != null) {
                ...
                public void onHandledOnAnotherDevice(StringeeCall stringeeCall, StringeeCall.SignalingState signalingState, String desc) {
                    Utils.runOnUiThread(() -> {
                        Log.d(Constant2.TAG, "onHandledOnAnotherDevice: " + signalingState);
                ...
                public void onMediaStateChange(StringeeCall stringeeCall, StringeeCall.MediaState mediaState) {
                    Utils.runOnUiThread(() -> {
                        Log.d(Constant2.TAG, "onMediaStateChange: " + mediaState);
                ...
                public void onLocalStream(StringeeCall stringeeCall) {
                    Utils.runOnUiThread(() -> {
                        Log.d(Constant2.TAG, "onLocalStream");
                        if (isVideoCall) {
                            if (listener != null) {
                ...
                public void onRemoteStream(StringeeCall stringeeCall) {
                    Utils.runOnUiThread(() -> {
                        Log.d(Constant2.TAG, "onRemoteStream");
                        if (isVideoCall) {
                            if (listener != null) {
                ...
                public void onCallInfo(StringeeCall stringeeCall, JSONObject jsonObject) {
                    Utils.runOnUiThread(() -> Log.d(Constant2.TAG, "onCallInfo: " + jsonObject.toString()));
                }
            });
        } else {
            stringeeCall2.setCallListener(new StringeeCall2.StringeeCallListener() {
                ...
                public void onVideoTrackAdded(StringeeVideoTrack stringeeVideoTrack) {
                    Utils.runOnUiThread(() -> {
                        Log.d(Constant2.TAG, "onVideoTrackAdded: " + stringeeVideoTrack.getId());
                ...
                public void onVideoTrackRemoved(StringeeVideoTrack stringeeVideoTrack) {
                    Utils.runOnUiThread(() -> {
                        Log.d(Constant2.TAG, "onVideoTrackRemoved: " + stringeeVideoTrack.getId());
                        if (stringeeVideoTrack.getTrackType() == StringeeVideoTrack.TrackType.SCREEN) {
                            if (listener != null) {
    ...
    private void handleResponse(String action, boolean isSuccess, String message) {
        Log.d(Constant2.TAG, action + ": " + (isSuccess ? "success" : message));
        if (!isSuccess) {
            if (listener != null) {
    ...
    public void startCapture(MyMediaProjectionService mediaProjectionService, Intent mediaProjectionPermissionResultData) {
        ...
        if (stringeeCall2 != null) {
            ...
            if (!isSharing) {
                screenCapture.createCapture(mediaProjectionPermissionResultData);
            }
        }
    }

    public void release() {
        Log.d(Constant2.TAG, "release callManager");
