...
import com.lephiha.do_an.databinding.StringeeActivityBinding;
...
//        makeCall(true, true);
    ...
    public void onClick(View view) {
        int vId = view.getId();
        if (vId == R.id.btn_voice_call) {
            makeCall(true, false);
        } else if (vId == R.id.btn_video_call) {
            makeCall(true, true);
        } else if (vId == R.id.btn_voice_call2) {
            makeCall(false, false);
        } else if (vId == R.id.btn_video_call2) {
            makeCall(false, true);
        }
    }
    ...
    private void makeCall(boolean isStringeeCall, boolean isVideoCall) {
        ...
        intent.putExtra(Constant2.PARAM_TO, binding.etTo.getText().toString().trim());
